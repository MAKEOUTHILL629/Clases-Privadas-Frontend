...
describe('workspace-project Estudiante', () => {
  ...
  it('Deberia crear tema', () => {
    ...
    browser.wait(
      EC.presenceOf(
        element(
          by.css(
            'body > app-root > app-skeleton > app-profesor-detail > div > div > div:nth-child(1) > ul > li:nth-child(2)'
          )
        )
      ),
      1000,
      'Esperando la actualizacion de la tabla de temas'
    );
  ...
  it('Deberia Actualizar tema', () => {
    ...
    browser.wait(
      EC.visibilityOf(profesor.getBotonActualizarTemaConfirmar()),
      1000,
      'Esperando que se observe el modal de actualizar'
    );
    ...
    expect(
      element(
        by.xpath(
          '/html/body/app-root/app-skeleton/app-profesor-detail/div/div/div[1]/ul/li[2]'
        )
      ).getText()
    ).toEqual('Test Actualizar Tema');
  });
  ...
  it('Deberia eliminar tema', () => {
    ...
    browser.wait(
      EC.visibilityOf(profesor.getBotonEliminarTemaConfirmar()),
      1000,
      'Esperando que se observe el modal de eliminar'
    );
  ...
  it('Deberia crear horario', () => {
    ...
    browser.wait(
      EC.elementToBeClickable(profesor.getBotonCrearHorario()),
      1000
    );
    ...
    browser.wait(
      EC.presenceOf(
        element(
          by.css(
            'body > app-root > app-skeleton > app-profesor-detail > div > div > div.col-md-5.mx-1 > table > tbody > tr:nth-child(2)'
          )
        )
      ),
      1000,
      'Esperando la actualizacion de la tabla de horarios'
    );
  ...
  it('Deberia Actualizar horario', () => {
    ...
    browser.wait(
      EC.visibilityOf(profesor.getBotonActualizarHorarioConfirmar()),
      1000,
      'Esperando que se observe el modal de actualizar'
    );
    ...
    expect(
      element(
        by.xpath(
          '/html/body/app-root/app-skeleton/app-profesor-detail/div/div/div[2]/table/tbody/tr[2]/th'
        )
      ).getText()
    ).not.toBe('MARTES');
  });

  it('Deberia eliminar horario', () => {
    const CANTIDAD_HORARIO = profesor.contarHorarios();
    profesor.clickBotonEliminarHorario();
    browser.wait(
      EC.visibilityOf(profesor.getBotonEliminarHorarioConfirmar()),
      1000,
      'Esperando que se observe el modal de eliminar'
    );
